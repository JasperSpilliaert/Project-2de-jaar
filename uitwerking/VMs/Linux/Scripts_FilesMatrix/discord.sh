...
sed -i 's#https://matrix.example.com#http://matrix.g03-fft.internal#g' config.yaml
sed -i 's#domain: example.com#domain: matrix.g03-fft.internal#g' config.yaml
sed -i 's#http://localhost:29334#http://matrix.g03-fft.internal:29334#g' config.yaml
...
sed -i 's#example.com: https://example.com#example.com: http://matrix.g03-fft.internal#g' config.yaml
sed -i 's#"example.com": user#"matrix.g03-fft.internal": user#g' config.yaml
sed -i 's#"@admin:example.com": admin#"@bot:matrix.g03-fft.internal": user#g' config.yaml
